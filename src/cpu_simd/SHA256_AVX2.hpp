...
class SHA256_AVX2_Engine : public core::IHashEngine {
public:
    core::HashType type() const override { return core::HashType::SHA256; }
    std::string name() const override { return "SHA256-AVX2"; }
    ...
    std::string kernelSourcePath() const override { return "kernels/sha256.cl"; }
    std::string kernelFunctionName() const override { return "sha256_crack"; }
